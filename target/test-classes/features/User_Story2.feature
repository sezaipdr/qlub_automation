@us2
  ...
  Background: Customer should be able to scan the QR code
    ...
    @US2_TC3
    Scenario: Customer should be able tochoose to see the bill that user ordered on the user's own table
      When User sees "Pay my Bill" button
      And User clicks "Pay my Bill" button
      And User sees the bill that user ordered on the user's own table
      Then User chooses the bill
